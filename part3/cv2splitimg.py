...
img = cv2.imread('part3/test2.png')

# Convert BGR image to RGB
RGB_img = cv2.cvtColor(img, cv2.COLOR_BGR2RGB)

# Get the shape of the image
image_height, image_width, channels = RGB_img.shape

# Calculate the size of the image in bytes
image_size_bytes = image_height * image_width * channels * RGB_img.itemsize
